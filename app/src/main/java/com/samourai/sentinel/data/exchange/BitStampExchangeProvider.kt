 ...
 * @author Sarath
 */
class BitStampExchangeProvider : ExchangeProviderImpl {

    private val bitStampEndpoint = "https://www.bitstamp.net/api/v2/ticker_hour/btc"
    ...
    override suspend fun fetch() {
        try {
            val request = Request.Builder()
                    .url(bitStampEndpoint + prefsUtil.selectedCurrency?.lowercase())
                    .build()
            try {
